...
function Community() {
    ...
    async (pageNum) => {
      ...
      try {
        const response = await axios.get(
          `https://universenode-chfnd3h6awepesd0.southindia-01.azurewebsites.net/communities/communityInfo/${communityId}`,
          {
  ...
  const checkIfUserIsOwner = useCallback(async () => {
    try {
      const response = await axios.get(
        `https://universenode-chfnd3h6awepesd0.southindia-01.azurewebsites.net/communities/checkIfUserIsOwner`,
        {
          params: {
  ...
  const handleLeaveCommunity = async () => {
    try {
      const response = await axios.delete(
        `https://universenode-chfnd3h6awepesd0.southindia-01.azurewebsites.net/communities/leaveCommunity`,
        {
          params: {
            userId: JSON.parse(localStorage.getItem("user")).id,
            communityId: communityId,
  ...
  const handleJoinCommunity = async () => {
    try {
      const response = await axios.patch(
        `https://universenode-chfnd3h6awepesd0.southindia-01.azurewebsites.net/communities/joinCommunity`,
        null,
        {
          params: {
            userId: JSON.parse(localStorage.getItem("user")).id,
