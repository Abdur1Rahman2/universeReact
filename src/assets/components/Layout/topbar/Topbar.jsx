...
function Topbar() {
  ...
  const fetchSearchPosts = async () => {
    try {
      const response = await axios.get(`https://universenode-chfnd3h6awepesd0.southindia-01.azurewebsites.net/posts/search`, {
        params: { searchValue },
      });
  ...
  const fetchNotifications = async () => {
    try {
      const response = await axios.get(
        "https://universenode-chfnd3h6awepesd0.southindia-01.azurewebsites.net/users/userNotifications",
        {
          params: {
