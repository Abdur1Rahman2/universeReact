...
function Comments({ postId, open, onClose }) {
  ...
  const fetchComments = useCallback(async () => {
    try {
      const response = await axios.post(
        "https://universenode-chfnd3h6awepesd0.southindia-01.azurewebsites.net/userPost/getComments",
        { postId }
      );
  ...
  const handleAddComment = useCallback(
    async (content) => {
      try {
        const response = await axios.post(
          "https://universenode-chfnd3h6awepesd0.southindia-01.azurewebsites.net/userPost/addComment",
          {
            postId,
  ...
  const handleAddReply = useCallback(
    async (commentId, content) => {
      try {
        const response = await axios.post(
          "https://universenode-chfnd3h6awepesd0.southindia-01.azurewebsites.net/userPost/addReply",
          {
            userId: JSON.parse(localStorage.getItem("user")).id,
            postId,
            commentId,
      ...
      try {
        if (!isLiked) {
          ...
          response = await axios.post(
            "https://universenode-chfnd3h6awepesd0.southindia-01.azurewebsites.net/userPost/addCommentLike",
            {
              userId,
              commentId,
            }
          ...
          response = await axios.delete(
            "https://universenode-chfnd3h6awepesd0.southindia-01.azurewebsites.net/userPost/deleteCommentLike",
            {
              params: {
                commentId,
                userId,
      ...
      try {
        ...
        try {
          if (!isLiked) {
            // Add like
            response = await axios.post(
              "https://universenode-chfnd3h6awepesd0.southindia-01.azurewebsites.net/userPost/addReplyLike",
              {
                commentId,
                userId,
                replyId,
            ...
            // Remove like
            response = await axios.delete(
              "https://universenode-chfnd3h6awepesd0.southindia-01.azurewebsites.net/userPost/deleteReplyLike",
              {
                params: {
                  commentId,
                  userId,
  ...
  const handleDeleteComment = useCallback(async (commentId) => {
    try {
      const userId = JSON.parse(localStorage.getItem("user")).id;
      await axios.delete(`https://universenode-chfnd3h6awepesd0.southindia-01.azurewebsites.net/posts/deleteComment`, {
  ...
  const handleDeleteReply = useCallback(async (commentId, replyId) => {
    try {
      const userId = JSON.parse(localStorage.getItem("user")).id;
      await axios.delete(`https://universenode-chfnd3h6awepesd0.southindia-01.azurewebsites.net/userPost/deleteReply`, {
