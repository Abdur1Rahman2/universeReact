...
const Post = forwardRef(({ post, onVisible }, ref) => {
    ...
    if (liked) {
      try {
        const response = await axios.delete(
          "https://universenode-chfnd3h6awepesd0.southindia-01.azurewebsites.net/userPost/deletePostLike",
          {
            params: {
              postId: post._id,
              userId: userId,
      ...
      try {
        const response = await axios.post(
          "https://universenode-chfnd3h6awepesd0.southindia-01.azurewebsites.net/userPost/addPostLike",
          {
            postId: post._id,
            userId: userId,
          }
  ...
  const handleConfirmDelete = async () => {
    try {
      const response = await axios.delete(
        `https://universenode-chfnd3h6awepesd0.southindia-01.azurewebsites.net/posts/deletePost`,
        {
          params: {
            postId: post._id,
