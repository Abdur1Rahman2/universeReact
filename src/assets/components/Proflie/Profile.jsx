  ...
  const fetchTotalUserCommunitiesJoined = async () => {
    try {
      const response = await axios.get(
        "https://universenode-chfnd3h6awepesd0.southindia-01.azurewebsites.net/communities/totalUserCommunitiesJoined",
        {
          params: {
      ...
      success: async (compressedFile) => {
        ...
        try {
          const response = await axios.patch(
            "https://universenode-chfnd3h6awepesd0.southindia-01.azurewebsites.net/users/changeProfilePhoto",
            formData,
            {
              headers: {
