    ...
    const fetchEmail = async () => {
      try {
        const response = await axios.get(
          `https://universenode-chfnd3h6awepesd0.southindia-01.azurewebsites.net/users/getUserEmail`,
          {
            params: {
  ...
  const handleSaveClick = async () => {
    ...
    try {
      const response = await axios.patch(
        `https://universenode-chfnd3h6awepesd0.southindia-01.azurewebsites.net/users/changeUsername`,
        {
  ...
  const handlePasswordSubmit = () => {
    ...
    try{
     response = axios.patch(
      `https://universenode-chfnd3h6awepesd0.southindia-01.azurewebsites.net/users/changePassword`,
      {
        userId,
